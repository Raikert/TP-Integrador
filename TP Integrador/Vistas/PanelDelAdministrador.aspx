...
&nbsp;<asp:Button ID="btnBorrarCategoria" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Borrar" ValidationGroup="2" />
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblABM_Editorial" runat="server" BackColor="#FFCC00" CssClass="auto-style10" Font-Names="Bahnschrift SemiBold" Text="ABM Editoriales" BorderColor="#FF6600" BorderWidth="5px"></asp:Label>
                        <br />
                        <br />&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp; 
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnMostrarEditoriales" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Mostrar editoriales" Width="138px" />
&nbsp;<asp:Button ID="btnBuscarEditorial" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Buscar por codigo" Width="134px" />
&nbsp;<asp:Button ID="btnAgregarEditorial" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Agregar" ValidationGroup="5" />
&nbsp;<asp:Button ID="btnModificarEditorial" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Modificar" />
&nbsp;<asp:Button ID="btnBorrarEditorial" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Borrar" ValidationGroup="4" />
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblABM_Proveedores" runat="server" BackColor="#FFCC00" CssClass="auto-style10" Font-Names="Bahnschrift SemiBold" Text="ABM Proveedores" BorderColor="#FF6600" BorderWidth="5px"></asp:Label>
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnMostrarResultados" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Mostrar resultados" Width="150px" />
&nbsp;<asp:Button ID="btnBuscarLibrosXProveedores" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Buscar por codigo " Width="134px" />
&nbsp;<asp:Button ID="btnAgregarLibroXProveedor" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Agregar" ValidationGroup="8" />
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnMostrarCliente" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Mostrar clientes" Width="115px" />
...
&nbsp;&nbsp;
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnMostrarVentas" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Mostrar ventas" Width="115px" />
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblCodigoVenta0" runat="server" CssClass="auto-style3" Font-Names="Candara Light" Text="Codigo de Venta"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblCodigoCliente1" runat="server" CssClass="auto-style3" Font-Names="Candara Light" Text="Codigo de Proveedor"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblCodigoLibro1" runat="server" CssClass="auto-style3" Font-Names="Candara Light" Text="Codigo de Libro"></asp:Label>
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="Cod_Venta_Dv" runat="server" Width="136px"></asp:TextBox>
&nbsp;&nbsp;
                        <asp:TextBox ID="Cod_Proveedor_Dv" runat="server" Width="168px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="Cod_Libro_Dv" runat="server" Width="136px"></asp:TextBox>
                    <br />
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnMostrarDetalleVentas" runat="server" BackColor="Lime" BorderColor="Black" CssClass="auto-style5" Text="Mostrar detalle ventas" Width="153px" />
